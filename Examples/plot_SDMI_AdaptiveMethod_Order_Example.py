#This example implements a 5 invader SDMI game with a Adaptive Clustering Method
...
## Compute Capture order With Adaptive Clustering Method
bestOrder = sfl.adaptiveClusteringOrder(I_array, Defender, G_circ, alpha, r,typeEff=0, InitMode=True, reInit = False, prevClust = 0)
